    (function() {
      ...
      function renderTree() {
        ...
        document.getElementById('tree-status').textContent = `${filtered.length} / ${flatNodes.length} 条目`;
      ...
      function formatExpandableOutput(text, maxLines, lang) {
        ...
        if (lang) {
          ...
          if (remaining > 0) {
            ...
            return `<div class="tool-output expandable" onclick="if(window.getSelection().toString())return;this.classList.toggle('expanded')">
              ...
              <div class="expand-hint">...（剩余 ${remaining} 行）</div></div>
        ...
        if (remaining > 0) {
          ...
          out += `<div class="expand-hint">...（剩余 ${remaining} 行）</div></div>`;
          ...
          <div class="header">
            ...
            <div class="help-bar">
              ...
              <div class="help-actions">
                ...
                <button type="button" class="download-json-btn" onclick="downloadSessionJson()" title="下载会话 JSONL">↓ JSONL</button>
              </div>
            </div>
