...
import { APP_NAME, getExportTemplateDir, isBunBinary } from "../../config.js";
...
function loadExportTemplates() {
    if (isBunBinary && globalThis.__EMBEDDED_EXPORT_TEMPLATES__) {
        const embeds = globalThis.__EMBEDDED_EXPORT_TEMPLATES__;
        return {
